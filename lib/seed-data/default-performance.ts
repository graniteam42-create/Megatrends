...
export const DEFAULT_PERFORMANCE: Record<string, { ticker: string; perf20d: number | null; perf60d: number | null }> = {
  ...
  "t4":  { ticker: "EUDF",  perf20d: 4.20,   perf60d: 9.10 },
  ...
  // New trends
  "t11": { ticker: "IQQQ",  perf20d: 1.80,   perf60d: 6.20 },
  "t12": { ticker: "MOO",   perf20d: 2.50,   perf60d: 3.80 },
  "t13": { ticker: "NUE",   perf20d: null,   perf60d: null },
  "t14": { ticker: "LEN",   perf20d: null,   perf60d: null },
  "t15": { ticker: "ITPS",  perf20d: 0.40,   perf60d: 1.10 },
};
