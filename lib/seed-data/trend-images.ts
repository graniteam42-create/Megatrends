...
export const TREND_IMAGES: Record<string, { url: string; thumb: string; credit: string }> = {
  ...
  "t11": { url: "https://images.pexels.com/photos/1446076/pexels-photo-1446076.jpeg?auto=compress&cs=tinysrgb&w=1280", thumb: "https://images.pexels.com/photos/1446076/pexels-photo-1446076.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop", credit: "Pexels" },  // Water infrastructure
  "t12": { url: "https://images.pexels.com/photos/2132171/pexels-photo-2132171.jpeg?auto=compress&cs=tinysrgb&w=1280", thumb: "https://images.pexels.com/photos/2132171/pexels-photo-2132171.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop", credit: "Pexels" },   // Food / agriculture
  "t13": { url: "https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=1280", thumb: "https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop", credit: "Pexels" },   // Overcapacity - industrial factory
  "t14": { url: "https://images.pexels.com/photos/280222/pexels-photo-280222.jpeg?auto=compress&cs=tinysrgb&w=1280", thumb: "https://images.pexels.com/photos/280222/pexels-photo-280222.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop", credit: "Pexels" },        // Housing
  "t15": { url: "https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=1280", thumb: "https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop", credit: "Pexels" },   // Labor / industrial
};

// Fallback images for AI-added custom trends, matched by keyword in trend name/description.
// Order matters: more specific categories first so "factory" matches before generic "automation".
const FALLBACK_IMAGES: { keywords: string[]; url: string; thumb: string }[] = [
  // Specific categories first (before generic ones grab the match)
  { keywords: ["factory", "manufactur", "3d print", "localized", "reshoring", "onshoring", "nearshoring", "industrial"],
    url: "https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=1280",
    thumb: "https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop" },
  { keywords: ["water", "scarcity", "drought", "desalination", "irrigation", "purification"],
  ...
  { keywords: ["food", "agriculture", "farming", "precision ag"],
  ...
  // Broader categories
  { keywords: ["ai", "artificial", "machine learning", "robot", "compute"],
  ...
  { keywords: ["automat"],
    url: "https://images.pexels.com/photos/3913025/pexels-photo-3913025.jpeg?auto=compress&cs=tinysrgb&w=1280",
    thumb: "https://images.pexels.com/photos/3913025/pexels-photo-3913025.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop" },
  { keywords: ["gold", "silver", "metal", "commodity", "monetary", "hard asset"],
  ...
  { keywords: ["defense", "military", "geopolit", "war", "nato"],
  ...
  { keywords: ["health", "aging", "demographic", "pharma", "medical", "biotech"],
  ...
  { keywords: ["cyber", "trust", "verification", "identity", "deepfake", "zero-trust", "security"],
  ...
  { keywords: ["carbon", "capture", "co2", "pollution"],
  ...
  { keywords: ["supply chain", "logistics", "shipping", "trade"],
    url: "https://images.pexels.com/photos/906494/pexels-photo-906494.jpeg?auto=compress&cs=tinysrgb&w=1280",
    thumb: "https://images.pexels.com/photos/906494/pexels-photo-906494.jpeg?auto=compress&cs=tinysrgb&w=200&h=80&fit=crop" },
];
